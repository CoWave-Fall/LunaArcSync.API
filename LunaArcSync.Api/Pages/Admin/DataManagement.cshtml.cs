...
namespace LunaArcSync.Api.Pages.Admin
{
    public class DataManagementModel : PageModel
    {
        private readonly ILogger<DataManagementModel> _logger;
        private readonly IHttpClientFactory _httpClientFactory;

        public DataManagementModel(ILogger<DataManagementModel> logger, IHttpClientFactory httpClientFactory)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> OnPostImportAsync(IFormFile file)
        {
            ...
            try
            {
                ...
                var request = new HttpRequestMessage(HttpMethod.Post, "/api/data/import");
